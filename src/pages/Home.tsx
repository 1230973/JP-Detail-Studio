...
export default function Home() {
  ...
  return (
    <div className="min-h-screen selection:bg-gold-brushed selection:text-matte-black relative">
      {/* Global Noise Texture */}
      <div className="fixed inset-0 z-[100] bg-noise pointer-events-none"></div>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ y: heroTextY, opacity: heroOpacity }} className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-20 bg-gold-brushed/20 blur-[50px] rounded-full"></div>
            
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-sans font-bold text-gold-brushed tracking-[0.2em] uppercase">
                PF Detail Studio
              </h2>
            </div>
          </motion.div>
      ...
      <section className="py-32 bg-[#111]">
        <div className="container mx-auto px-6">
          ...
          >
            <a 
              href="https://instagram.com/pf_detailstudio" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 border border-gold-brushed/30 text-gold-brushed px-8 py-4 rounded-full font-medium hover:bg-gold-brushed hover:text-matte-black transition-all duration-300"
            >
              <Instagram className="w-5 h-5" />
              Explorar Portfólio no Instagram
            </a>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 bg-matte-black relative">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            {/* Floating Info Card (Top on Mobile, Left on Desktop) */}
            <motion.div 
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: true }}
              className="order-1 flex flex-col justify-center space-y-8 p-8 md:p-10 bg-white/5 backdrop-blur-xl rounded-[2rem] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
            >
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-5 group">
                  ...
                  <div>
                    ...
                    <a href="https://instagram.com/pf_detailstudio" target="_blank" rel="noopener noreferrer" className="text-silver-polished hover:text-gold-brushed transition-colors flex items-center gap-2 text-lg">
                      @pf_detailstudio <ExternalLink className="w-4 h-4" />
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="order-2 rounded-[2rem] overflow-hidden h-[400px] lg:h-[600px] border border-white/10 shadow-2xl w-full">
              <iframe 
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center space-y-8">
            <div className="opacity-90">
              <h2 className="text-2xl font-sans font-bold text-gold-brushed tracking-[0.2em] uppercase">
                PF Detail Studio
              </h2>
            </div>
